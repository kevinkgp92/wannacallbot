...
class BootstrapSplash:
    def __init__(self):
        ...
        # Version Tag
        tk.Label(self.root, text="Titan Apex v2.2.98 (LOGIC RELAX)", font=("Arial", 8), fg="#333", bg="#16161d").pack(side="bottom", pady=5)
...
class OsintGUI(ctk.CTk):
    ...
    def _build_main_ui(self):
        ...
        self.btn_start = ctk.CTkButton(self.action_frame, text=f"!!! INICIAR v2.2.98 !!!", command=self.start_process, 
